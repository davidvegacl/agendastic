 ...
 * and the Agendastic system. Do not place any model handling inside this
 * library.
 *
 * @package Libraries
 */
class Google_Sync {
     ...
     * where the user grants access to his data for the Agendastic app.
     */
     ...
     * when the provider granted consent to Agendastic for use his
     ...
     * Sync utility of Agendastic and the stored access token is still valid.
     ...
     * provided appointment record of Agendastic.
     *
     * @param array $appointment Contains the appointment record data.
     * @param array $provider Contains the provider record data.
     * @param array $service Contains the service record data.
